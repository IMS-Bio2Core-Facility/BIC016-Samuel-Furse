...
ADI_F1A_p_ve_metadata <- read.csv("./Data/+ve, ADI, F1A.csv", stringsAsFactors=F)
ADI_F1A_p_ve <-read.csv("./Data/+ve, ADI, F1A.csv", stringsAsFactors=F , skip=10 ) 
...
write.csv(SER_ADI_F1A_p_ve_NN_common,"./Results_F1A_p_ve/SER_ADI_F1A_p_ve_NN_common.csv")
write.csv(SER_ADI_F1A_p_ve_LL_common,"./Results_F1A_p_ve/SER_ADI_F1A_p_ve_LL_common.csv")
...
write.csv(SER_LIV_F1A_p_ve_NN_common,"./Results_F1A_p_ve/SER_LIV_F1A_p_ve_NN_common.csv")
write.csv(SER_LIV_F1A_p_ve_LL_common,"./Results_F1A_p_ve/SER_LIV_F1A_p_ve_LL_common.csv")
...
write.csv(SER_HEA_F1A_p_ve_NN_common,"./Results_F1A_p_ve/SER_HEA_F1A_p_ve_NN_common.csv")
write.csv(SER_HEA_F1A_p_ve_LL_common,"./Results/SER_HEA_F1A_p_ve_LL_common.csv")
...
write.csv(SER_CEB_F1A_p_ve_NN_common,"./Results_F1A_p_ve/SER_CEB_F1A_p_ve_NN_common.csv")
write.csv(SER_CEB_F1A_p_ve_LL_common,"./Results_F1A_p_ve/SER_CEB_F1A_p_ve_LL_common.csv")
...
write.csv(SER_RiB_F1A_p_ve_NN_common,"./Results_F1A_p_ve/SER_RiB_F1A_p_ve_NN_common.csv")
write.csv(SER_RiB_F1A_p_ve_LL_common,"./Results_F1A_p_ve/SER_RiB_F1A_p_ve_LL_common.csv")
...
write.csv(A_set_F1A_NN,"./Results_F1A_p_ve/A_set_F1A_NN.csv")
...
write.csv(A_set_F1A_LL,"./Results_F1A_p_ve/A_set_F1A_LL.csv")
...
write.csv(ADI_F1A_p_ve_NN_unique,"./Results_F1A_p_ve/ADI_F1A_p_ve_NN_unique.csv")
#
#
...
write.csv(ADI_F1A_p_ve_LL_unique,"./Results_F1A_p_ve/ADI_F1A_p_ve_LL_unique.csv")
...
write.csv(LIV_F1A_p_ve_NN_unique,"./Results_F1A_p_ve/LIV_F1A_p_ve_NN_unique.csv")
...
write.csv(LIV_F1A_p_ve_LL_unique,"./Results_F1A_p_ve/LIV_F1A_p_ve_LL_unique.csv")
...
write.csv(HEA_F1A_p_ve_NN_unique,"./Results_F1A_p_ve/HEA_F1A_p_ve_NN_unique.csv")
...
write.csv(HEA_F1A_p_ve_LL_unique,"./Results_F1A_p_ve/HEA_F1A_p_ve_LL_unique.csv")
...
write.csv(CEB_F1A_p_ve_NN_unique,"./Results_F1A_p_ve/CEB_F1A_p_ve_NN_unique.csv")
#
#
...
write.csv(CEB_F1A_p_ve_LL_unique,"./Results_F1A_p_ve/CEB_F1A_p_ve_LL_unique.csv")
...
write.csv(RiB_F1A_p_ve_NN_unique,"./Results_F1A_p_ve/RiB_F1A_p_ve_NN_unique.csv")
#
#
...
write.csv(RiB_F1A_p_ve_LL_unique,"./Results_F1A_p_ve/RiB_F1A_p_ve_LL_unique.csv")
...
write.csv(SER_F1A_p_ve_NN_unique,"./Results_F1A_p_ve/SER_F1A_p_ve_NN_unique.csv")
#
#
...
write.csv(SER_F1A_p_ve_LL_unique,"./Results_F1A_p_ve/SER_F1A_p_ve_LL_unique.csv")
...
write.csv(F1A_p_ve_meandiffs, file = "F1A_p_ve_meandiffs.csv")
