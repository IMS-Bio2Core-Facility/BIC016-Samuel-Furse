...
setwd("~/Dropbox (Cambridge University)/Bioinformatics_core/Projects/Samuel_Furse_Project/Further_analyses_with_V2.0/PWD_project/Results-plus_ve/")# <--- insert here the path to the working (output) directory
